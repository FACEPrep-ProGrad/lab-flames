...
public class FlamesCheck extends HttpServlet {
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response)
		  ...
		  char k = (char) fcs.findFlames(name1,name2);
		  ...
		  } else if (k == 's') { RequestDispatcher rd=this.getServletContext().getRequestDispatcher("/WEB-INF/views/siblings.jsp"); rd.forward(request, response);
